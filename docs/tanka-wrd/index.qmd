...
こうして得た前後2つのまとまりのそれぞれについて、Sudachi（+SudachiDict-core 20240109）を使って形態素解析をおこない、得られる2つの単語列間のWRDを計算した。
...
このグラフを見るかぎりでは、同じくらいの長さの文字列では短歌でもツイートでも似たような分布になっているように見える。
